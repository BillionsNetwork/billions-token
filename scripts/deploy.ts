...
async function main() {
    ...
    console.log('----------------------------------');
    console.log('TOKEN_PROXY_ADDRESS=', tokenAddress);
    console.log('TIMELOCK_ADDRESS=', timelockAddress);
    console.log('TOKEN_PROXY_ADMIN_ADDRESS=', adminAddress);
    console.log('TOKEN_IMPLEMENTATION_ADDRESS=', implementationAddress);
    console.log('----------------------------------');
    ...
    await verifyContract(timelockAddress, {
        constructorArgsImplementation: [MIN_DELAY.toString(), proposers, executors, admin],
        libraries: {},
    });
}
